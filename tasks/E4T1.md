# E4T1 — Implement /start command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Create a handler for /start that replies with a welcome message and a list of available commands with examples. This should be implemented in src/handlers/start.ts.
