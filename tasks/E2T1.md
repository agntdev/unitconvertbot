# E2T1 — Create parseNumber utility

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Implement a utility function in src/utils/parseNumber.ts that normalizes comma to dot, parses the first token after the command, and returns a number or throws an error if the input is invalid.
