# E3T1 — Add error handling to all command handlers

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Wrap the logic of each command handler in a try/catch block. On error, reply with 'An error occurred; please try again' and log the stack trace to the console.
