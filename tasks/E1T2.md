# E1T2 — Implement /f2c command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Create a handler for /f2c that parses the input, converts Fahrenheit to Celsius using the formula C = (F - 32) * 5/9, and returns the result rounded to 2 decimals. Write a test spec in tests/specs/E1T2.json and add the command to tests/commands.json.
