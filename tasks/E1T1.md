# E1T1 — Implement /c2f command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Create a handler for /c2f that parses the input, converts Celsius to Fahrenheit using the formula F = C * 9/5 + 32, and returns the result rounded to 2 decimals. Write a test spec in tests/specs/E1T1.json and add the command to tests/commands.json.
