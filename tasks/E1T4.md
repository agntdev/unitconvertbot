# E1T4 — Implement /mi2km command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Create a handler for /mi2km that parses the input, converts miles to kilometers using the formula km = mi / 0.621371, and returns the result rounded to 2 decimals. Write a test spec in tests/specs/E1T4.json and add the command to tests/commands.json.
