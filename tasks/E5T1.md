# E5T1 — Create conversion utility functions

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Implement a utility file src/utils/conversions.ts with functions for Celsius to Fahrenheit, Fahrenheit to Celsius, kilometers to miles, and miles to kilometers. Also include a rounding helper that rounds to 2 decimal places using toFixed(2).
