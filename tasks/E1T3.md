# E1T3 — Implement /km2mi command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Create a handler for /km2mi that parses the input, converts kilometers to miles using the formula mi = km * 0.621371, and returns the result rounded to 2 decimals. Write a test spec in tests/specs/E1T3.json and add the command to tests/commands.json.
