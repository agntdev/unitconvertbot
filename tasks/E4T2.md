# E4T2 — Implement /help command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 UCB

Create a handler for /help that replies with a list of commands, usage examples, and notes about decimal input and rounding. This should be implemented in src/handlers/help.ts.
